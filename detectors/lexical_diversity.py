...
def calculate_lexical_diversity_metrics(words: list) -> dict:
    """
...
def lex_diversity(cleaned_text: str) -> dict:
    ...
    avg_sentence_len = calculate_avg_sentence_length(sentences)

    words = cleaned_text.split()
    # Calculate lexical diversity
    lexical_diversity = calculate_lexical_diversity_metrics(words)
    return {
